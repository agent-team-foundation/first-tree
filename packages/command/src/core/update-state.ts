...
import { type UpdateAttempt, updateAttemptSchema } from "@agent-team-foundation/first-tree-hub-shared";
...
export type { UpdateAttempt } from "@agent-team-foundation/first-tree-hub-shared";
