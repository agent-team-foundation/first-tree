...
export class Dispatcher {
  ...
  private async runTask(
    ...
    for (const spec of agents) {
      // Per-spec controller: runWithTimeout's kill aborts it, the
      // spawner watches it and SIGTERM/SIGKILLs the child. Without this
      // wiring the timeout reports "timed_out" while the agent keeps
      // running and can still mutate GitHub.
