...
CREATE INDEX "idx_gitlab_identity_transition_link_created" ON "gitlab_identity_transition_audit" USING btree ("identity_link_id","created_at");--> statement-breakpoint
