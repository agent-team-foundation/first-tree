 ...
 *                                     dedup — codex P1-6), then run mention
 *                                     delegation. If no binding exists yet
 *                                     (webhook racing ahead of the OAuth-
 *                                     callback bind), reply 503 WITHOUT
 *                                     claiming so GitHub redelivers once
 *                                     the bind lands.
 */
