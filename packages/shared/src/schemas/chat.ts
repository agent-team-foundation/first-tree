 ...
 */
export const legacyCreateChatSchema = z
  .object({
  ...
  .refine((value) => !(value.metadata?.source === "github" && value.metadata.contextTreeReviewer === true), {
    message: "Context Reviewer chat metadata is reserved for the GitHub App webhook service.",
    path: ["metadata"],
  });
