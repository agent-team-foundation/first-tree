...
export const DEFAULT_CONFIG_DIR = join(homedir(), ".first-tree-core");
...
const CONFIG_HEADER =
  "# Generated by first-tree-core. Edit as needed.\n# https://github.com/agent-team-foundation/first-tree-core\n\n";
