...
describe("first-tree-welcome repo_work lane", () => {
  it("keeps the growth repo first chat inside the existing welcome skill", () => {
    expect(welcomeSkill).toContain("repo_work");
    expect(welcomeSkill).toContain("Find work worth continuing");
