...
- `skills/first-tree-context/SKILL.md` — Context Tree concept and writing guide (concept model, source-system boundary, authorship read-discipline, and durable writing principles).
...
- `skills/` — repo-local skill payloads (`first-tree`, `first-tree-context`, `first-tree-write`, `first-tree-read`, `first-tree-sync`, `first-tree-seed`)
