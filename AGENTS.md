...
- **Tree repo:** `first-tree-context`
- **GitHub tree repo:** `agent-team-foundation/first-tree-context`
- **Binding mode:** `shared-source`
- **Entrypoint:** `/repos/first-tree-hub`
...
FIRST-TREE-TREE-REPO-SLUG: `agent-team-foundation/first-tree-context`
...
FIRST-TREE-ENTRYPOINT: `/repos/first-tree-hub`
...
- If you do not already have that tree repo cloned locally, clone a temporary working copy from `https://github.com/agent-team-foundation/first-tree-context` into `.first-tree/tmp/first-tree-context/`, use it for the current task, and delete it before you finish.
