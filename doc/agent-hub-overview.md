...
本文档定义 Agent Hub 的系统架构、子系统边界与接口、数据模型和部署架构。Server 的内部实现细节见 [Server 详细设计](agent-hub-server-detailed-design.md)。
...
详见 [Server 详细设计 §1](agent-hub-server-detailed-design.md)。
...
安全原则（基于 OpenClaw 教训，详见 [Server 详细设计 §9](agent-hub-server-detailed-design.md)）：
...
完整端点定义见 [Server 详细设计 §4](agent-hub-server-detailed-design.md)。
...
完整 DDL 见 [Server 详细设计 §3](agent-hub-server-detailed-design.md)。
