...
import { listTreeBindings } from "#engine/runtime/binding-state.js";
import { resolveBundledPackageRoot } from "#engine/runtime/installer.js";
...
export function runInvite(options: InviteOptions): number {
  ...
  const frameworkRoot = join(packageRoot, "assets", "framework");
