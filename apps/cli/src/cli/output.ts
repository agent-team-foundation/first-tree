...
import type { FailureOutputOptions } from "../core/output.js";
...
export function fail(code: string, message: string, exitCode = 1, options?: FailureOutputOptions): never {
  return print.fail(code, message, exitCode, options);
}
